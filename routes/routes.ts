  ...
  ResponseType: {
    ...
    type: {
      ...
      subSchemas: [
        ...
        { dataType: "enum", enums: ["cors"] },
        { dataType: "enum", enums: ["default"] },
        { dataType: "enum", enums: ["error"] },
        { dataType: "enum", enums: ["opaque"] },
        { dataType: "enum", enums: ["opaqueredirect"] },
      ],
      validators: {},
    },
  },
  ...
  Response: {
    ...
    properties: {
      body: {
        dataType: "union",
        subSchemas: [
          { ref: "ReadableStream_Uint8Array_" },
...
export function RegisterRoutes(app: express.Router) {
  ...
  // ###########################################################################################################
  app.get(
    "/api/datamall/busroute/:skipValue",
    ...fetchMiddlewares<RequestHandler>(DataMallController),
    ...fetchMiddlewares<RequestHandler>(
      DataMallController.prototype.getBusRoutes
    ),

    function DataMallController_getBusRoutes(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getBusRoutes.apply(
          controller,
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  app.get(
    "/api/datamall/carparkavailability/:skipValue",
    ...fetchMiddlewares<RequestHandler>(DataMallController),
    ...fetchMiddlewares<RequestHandler>(
      DataMallController.prototype.getCarparkAvailability
    ),

    function DataMallController_getCarparkAvailability(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getCarparkAvailability.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
